...
| GitHub Actions | `ubuntu-24.04` for portable checks; `actions/checkout` v7.0.1 pinned to a release commit. Mac ARM64 runner 2.337.0 archive SHA-256 `5a2cd92908a93d7276a194e1de6008099f3e7946f3f8e14aa7a1a7b4a31fdec2` | Hosted Linux CI is active. The Mac runner completed integration runs, then was de-registered from this public repository because fork workflows could request it. The installed binary remains for a future isolated setup. [Runner license](https://github.com/actions/runner/blob/main/LICENSE). |
