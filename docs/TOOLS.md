...
| GitHub Actions | `ubuntu-24.04` for portable checks; repository-scoped Mac ARM64 runner 2.337.0, archive SHA-256 `5a2cd92908a93d7276a194e1de6008099f3e7946f3f8e14aa7a1a7b4a31fdec2`; `actions/checkout` and `actions/upload-artifact` v7.0.1 pinned to release commits | Workflow execution service. Runner registered and online on 2026-09-20; required branch checks need a successful pull-request run. [Runner license](https://github.com/actions/runner/blob/main/LICENSE). |
